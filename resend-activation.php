...
echo "<h2>Enter the data to get another activation email:</h2><div id='regbox'>";
...
{
	echo "<form name='resendActivation' action='".$_SERVER['PHP_SELF']."' method='post' class='form-horizontal'>
